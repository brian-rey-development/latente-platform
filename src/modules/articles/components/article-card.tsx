  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-8 flex flex-col flex-grow">
        <span className="font-mono text-xs font-bold tracking-widest text-brand uppercase mb-4 block">
          {resolved.category}
        </span>
        <h3 className="font-sans font-black text-3xl leading-[1.1] mb-4 uppercase group-hover:text-surface">
          {resolved.title}
        </h3>
        <p className="font-serif text-muted group-hover:text-dim text-lg leading-snug mb-8 flex-grow">
          {resolved.excerpt}
        </p>
        <div className="flex justify-between items-center pt-4 border-t-2 border-ink group-hover:border-border font-mono text-xs font-bold uppercase tracking-widest">
